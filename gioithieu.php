...
<head>
	...
	<!-- <script src="https://uhchat.net/code.php?f=379f68"></script> -->
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="row">
			<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
				<img src="Images/logo.png" title="Dịch Vụ Spa Tảo Tuấn" style="margin-top: 10px; margin-bottom: 5px;margin-left: -20px; width: 140px;">
			</div>
			...
			<div class="col-xs-2 col-sm-2 col-md-2 col-lg-1">
				<div class="row">
					<div class="container">
						...
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#loginModal" style="margin-top: 30px;">
							Đăng nhập
						</button>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<form class="email-signup">
											<div class="u-form-group">
												Email: <input type="email" placeholder="Email" id='login-email' />
											</div>
											<div class="u-form-group">
												Mật khẩu: <input type="password" placeholder="Password" id='login-password' />
											</div>
									...
									<div class="modal-footer">
										...
										<button type="button" id="login"class="btn btn-default" onclick="login_func()">Đăng nhập</button>
									</div>
				...
				<div class="row">
					<div class="container">
						<!-- Button to Open the Modal -->
						<button type="button" class="btn btn-primary" style="margin-top: 20px;" data-toggle="modal" data-target="#signupModal">
							Đăng ký
						</button>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<form class="email-signup">
											<div class="u-form-group">
												Email: <input type="email" placeholder="Email" id='signup-email' />
											</div>
											<div class="u-form-group">
												Mật khẩu: <input type="password" placeholder="Password" id='signup-password' />
											</div>
											<div class="u-form-group">
												Nhập lại mật khẩu: <input type="password" placeholder="Confirm Password" id='signup-confirm-password' />
											</div>
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-danger" data-dismiss="modal">Đóng</button>
										<button type="button" id="signup"class="btn btn-default" onclick="signup_func()">Đăng ký</button>
									</div>
					...
					<div id="header">
						<nav class="navbar navbar-inverse" style="margin-top: 0px">
							<div class="navbar-header" style="height: 0px" >
								<a href="home.html" title="Dịch Vụ Spa Thương Tuấn" class="navbar-brand" id="maumenu">Tảo Tuấn Spa</a>
							</div>
							...
							<div class="collapse navbar-collapse menubar" id="collapse">
								<ul class="nav navbar-nav navbar-right menubar">
									<li><a href="home.html" title="Trang Chủ"  id="maumenu"><span class="glyphicon glyphicon-home"></span> Trang chủ</a></li>
									<li><a href="gioithieu.html" title="Giới Thiệu" id="maumenu"> <span class="glyphicon glyphicon-star-empty"></span>Giới thiệu</a></li>
									<li class="dropdown" >
										...
										<ul class="dropdown-menu menubar">
											<li><a href="dieutri.html" title="Điều Trị">Điều Trị</a></li>
									...
									<li><a href="baiviet.html" title="Bài Viết"  id="maumenu" ><span class="glyphicon glyphicon-menu-hamburger"></span>Bài Viết</a></li>
									<li><a href="select.php" title="Chi tiết sản phẩm"  id="maumenu" ><span class="glyphicon glyphicon-star-empty"></span>Sản Phẩm</a></li>
									<li><a href="lienhe.html" title="Liên hệ" id="maumenu" ><span class="glyphicon glyphicon-envelope"></span> Liên hệ</a></li>
								</ul>
							</div>
						</nav>
					</div>
					...
					if($result = mysqli_query($mysqli, $sql)){
						if(mysqli_num_rows($result) > 0){
							while($row = mysqli_fetch_array($result)){?>
								...
								<a href="#"><img src="<?php echo  "./uploads/".$row['img'] ?>" class="media-object" heigh=100px width=179></a>
								</div>
								<div class="media-body">
								<h4 class="media-heading">Thông Tin Sản Phẩm</h4>
...
<div class="row  wow bounceInUp"  data-wow-duration="2s" data-wow-delay="0s" data-wow-interaion="1">
	<div class="  col-sm-12  ">
		<h2 id="cauhoi">Tại sao nên chọn Thương Tuấn Spa ?</h2></br>
		<div class="row">
			<div class="  col-sm-3 ">
				<div class="">
	...
	<div class="row">      
		...
		<div class="row">
			<div class="author contact"> Thiết kế bởi: 
				...
				<a href="fb.html"> - Lê Thị Mai Thương</a>
			</div>
		</div>
	</div>
</div>
